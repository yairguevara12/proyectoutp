...
public class PanelPeliculas extends javax.swing.JDialog {
    ...
    public PanelPeliculas(java.awt.Frame parent, boolean modal , ArrayList<Pelicula> Arraypeliculas) {
        super(parent, modal);
        initComponents();
        arrayPeliculas = Arraypeliculas ;
        System.out.println(arrayPeliculas.get(0).nombre);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PanelPeliculas dialog = new PanelPeliculas(new javax.swing.JFrame(), true ,  new ArrayList<Pelicula>());
